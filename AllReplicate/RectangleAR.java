...
public class RectangleAR  implements Writable, Comparable<RectangleAR>{
	...
	public RectangleAR(int rowNum, int relIndex,double x1, double y1, double x2,double y2) {
		this.rowNum = rowNum;
	...
	public RectangleAR(RectangleAR r) {
	...
	@Override
	public int compareTo(RectangleAR arg0) {
