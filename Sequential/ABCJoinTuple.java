...
public class ABCJoinTuple  implements Writable, Comparable<ABCJoinTuple>{
	...
	public String toString() {
		return abcType+","+JoinType + ","+r1RowNum+ ","+r2RowNum+ ","+r3RowNum+ ","+r1RelationIndex+ ","+r2RelationIndex+","+r3RelationIndex+","+r1x1+","+r1y1+","+r1x2+","+r1y2+","+r2x1+","+r2y1+","+r2x2+","+r2y2+","+r3x1+","+r3y1+","+r3x2+","+r3y2;
	}
}